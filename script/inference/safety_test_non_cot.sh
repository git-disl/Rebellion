...
#SBATCH -o safety_bench_non_cot-%j.out                         # Combined output and error messages file
...
CUDA_VISIBLE_DEVICES=0 python pred.py \
	...
	--data_dir anonymous4486/audio_beavertail_30k_test \
	--output_dir ../../data/poison/${path_after_slash}_inf_non_cot \
	--reward_format non_cot

CUDA_VISIBLE_DEVICES=0 python eval_sentiment.py \
	--input_path ../../data/poison/${path_after_slash}_inf_non_cot
