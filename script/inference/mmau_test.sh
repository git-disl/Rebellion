...
#SBATCH -o mmau_bench-%j.out                         # Combined output and error messages file
...
CUDA_VISIBLE_DEVICES=0 python pred.py \
	...
	--audio_dir ../data/mmau \
	--output_dir ../data/mmau/result/${path_after_slash}.json \
	--reward_format cot

	
python evaluation.py --input ../data/mmau/result/${path_after_slash}.json 
