...
if __name__ == "__main__":
    ...
    output_key = 'output' # The key that contains model output
    no_pred_count = 0
    matched_outputs = []
    new_data = []
    ...
    data_lst = []
    data_lst+= ["Total Accuracy :{:.2f}".format((corr/total) * 100)] 
    print("input path: {}".format(args.input))
    with open(f'{args.input}_eval.json', 'w', encoding='utf-8') as f:
